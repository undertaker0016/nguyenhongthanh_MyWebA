        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" required value="{{ old('slug', $post->slug) }}">
            ...
            <div class="col-md-4">
                ...
                <div class="mb-3">
                    ...
                    @if($post->image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $post->image) }}" alt="Current image" style="max-width: 100%; height: auto;">
                        </div>
                    @endif
